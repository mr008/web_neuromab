...
<cfinclude template="include/header.cfm">
        ...
        <cfquery datasource="#request.dsn#" name="qCatalog">
            ...
            <cfif len(trim(form.keywords))>
				where 
                	target like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    targetType like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    AccessionNum like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR"> 
                    or
                    AccessionRef like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR"> 
                    or
                    Clone like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    AICatalogTCSupe like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR"> 
                    or
                    AICatalogPure like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    CatABIDTCSupe like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    CatABIDPure like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
                    or
                    HumanGeneName like <cfqueryparam value="'%#form.keywords#%'" cfsqltype="CF_SQL_CHAR">
			</cfif>
            order by target;
        </cfquery>
        <!--- 
            ...
            <cfform id="NeuromabCatalog">
            	<td>
                    ...
                    <cfgrid name="catalog" format="html">
                        ...
                        <cfgridcolumn name="RRIDAB" header="RRID:AB_" width="70">
                        <cfloop query="qCatalog">
                            ...
                            <cfset RRIDABURL = '<a href="https://www.antibodyregistry.org/search.php?q=AB_#qCatalog.RRIDAB#" target="_blank" >#qCatalog.RRIDAB#</a>'>
