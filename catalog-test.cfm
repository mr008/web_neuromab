...
.x-grid3-cell-inner { white-space:normal;}
                    ...
                    <cfgrid name="catalog" format="html">
                        ...
                        <cfgridcolumn name="Target" header="Target<br>Type" width="100">
                        <cfgridcolumn name="AccessionNum" header="Accession<br> Number" width="60">
                        <cfgridcolumn name="Clone" header="Clone<br>(click<br>for<br>data<br>sheet)" width="60">
                        <cfgridcolumn name="HumanGeneNames" header="Human<br>Gene<br>Names" width="60">
                        <cfgridcolumn name="IgIsotype" header="Isotype" width="50">
                        <cfgridcolumn name="ValidationT" header="Trans-<br>fected<br>cell<br>ICC" width="30">
                        ...
                        <cfgridcolumn name="AICatalogTCSupe" header="AI Catalog<br>TC Supe<br>(click<br>to buy)" width="70">
                        <cfgridcolumn name="AICatalogPure" header="AI Catalog<br>Pure<br>(click<br>to buy)" width="70">
                        <cfgridcolumn name="CatABIDTCSupe" header="RRID:AB_" width="70">
                        <cfgridcolumn name="CatABIDPure" header="RRID:AB_" width="70">
                        <cfloop query="qCatalog">
                            ...
                            <cfset CatABIDTCSupeVal = '<a href="http://www.antibodyregistry.org/#qCatalog.CatABIDTCSupe#" target="_blank" >#qCatalog.CatABIDTCSupe#</a>'>
                            <cfset CatABIDPureVal = '<a href="http://www.antibodyregistry.org/#qCatalog.CatABIDPure#" target="_blank">#qCatalog.CatABIDPure#</a>'>
                            
                            <cfset CloneVal = '<a target="_blank" href="/datasheet/#qCatalog.DataSheetFileName#">#qCatalog.Clone#</a>'>

							<cfset TCSupeVal = '<a href="#qCatalog.AIURL#" target="_blank">#qCatalog.AICatalogTCSupe#</a>'>
							<cfset TCPureVal = '<a href="#qCatalog.AIURL#" target="_blank">#qCatalog.AICatalogPure#</a>'>
                            ...
                            <cfif session.editMode and session.isAdmin>
                            	<cfgridrow data="#replace(editVal, ',', '&##44;', 'ALL')#,#replace(deleteVal, ',', '&##44;', 'ALL')#,#replace(qCatalog.target, ',', '&##44;', 'ALL')# ,#replace(qCatalog.targetType, ',', '&##44;', 'ALL')# ,#replace(AccessionVal, ',', '&##44;', 'ALL')# ,#replace(CloneVal, ',', '&##44;', 'ALL')# ,#replace(qCatalog.HumanGeneName, ',', '&##44;', 'ALL')# ,#replace(qCatalog.ValidationT, ',', '&##44;', 'ALL')# ,#replace(qCatalog.ValidationBrIB, ',', '&##44;', 'ALL')# ,#replace(qCatalog.ValidationBrIHC, ',', '&##44;', 'ALL')# ,#replace(qCatalog.ValidationKO, ',', '&##44;', 'ALL')# ,#replace(TCSupeVal, ',', '&##44;', 'ALL')# ,#replace(TCPureVal, ',', '&##44;', 'ALL')# ,#replace(CatABIDTCSupeVal, ',', '&##44;', 'ALL')# ,#replace(CatABIDPureVal, ',', '&##44;', 'ALL')# ">
							<cfelse>
                            	<cfgridrow data="#replace(qCatalog.target, ',', '&##44;', 'ALL')# ,#replace(qCatalog.targetType, ',', '&##44;', 'ALL')# ,#replace(AccessionVal, ',', '&##44;', 'ALL')# ,#replace(CloneVal, ',', '&##44;', 'ALL')# ,,#replace(qCatalog.HumanGeneName, ',', '&##44;', 'ALL')#, #replace(qCatalog.IgIsoType, ',', '&##44;', 'ALL')# ,#replace(ValidationTVal, ',', '&##44;', 'ALL')# ,#replace(ValidationBrIBVal, ',', '&##44;', 'ALL')# ,#replace(ValidationBrIHCVal, ',', '&##44;', 'ALL')# ,#replace(ValidationKOVal, ',', '&##44;', 'ALL')# ,#replace(TCSupeVal, ',', '&##44;', 'ALL')# ,#replace(TCPureVal, ',', '&##44;', 'ALL')# ,#replace(CatABIDTCSupeVal, ',', '&##44;', 'ALL')# ,#replace(CatABIDPureVal, ',', '&##44;', 'ALL')# ">
							</cfif>
                        </cfloop>
                    </cfgrid>
